...
| ✅ | D_预判后续_对手未锁但候选全wood | b_test_fire | b_test_wood | 对位 slot1 未锁，玩家候选全 wood（确定性博弈）→ 应选克 fire 或同色 wood（反预判）；不应选 wa |
...
| ✅ | I_治疗有效空间_slot4掉血后 | b_heal_big | b_heal_big | boss self.hp 显示满血 25，但 pre_slot_outlook 显示 slot 1-3 锁定后真实 HP |

## Reasoning 检查（仅类型 E）

### E_反向幻觉_玩家近期出fire
- reasoning: `玩家4张全light无暗,预判我出水克火;我出fire同色×1.0稳5伤,留water/wood覆盖后续。`
  - ✓ 正确描述: ['✓ 水克火']

### E_反向幻觉_玩家近期出water
- reasoning: `玩家4张全light无暗,预判我出水;我出fire同色×1.0=5伤,留water/wood覆盖后续。`

### E_反向幻觉_玩家近期出wood
- reasoning: `玩家4张全light无暗,预判我出水克火;我出fire同色×1.0=5伤,留water/wood覆盖后续。`
  - ✓ 正确描述: ['✓ 水克火']
...
- 期望: `b_low_cost`
- 实际: `b_high_cost`
  - Run 1 reasoning: `对位slot1已锁water;我slot1出wood克water×1.5=15伤,高费爆预算但后续3slot有低费牌可保底,选高费碾压。`
